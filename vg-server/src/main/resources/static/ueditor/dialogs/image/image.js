...
(function () {
    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            // WebUploader实例
                uploader,
                actionUrl = "/uploadImg",//editor.getActionUrl(editor.getOpt('imageActionName'))
            ...
            uploader.on('uploadSuccess', function (file, ret) {
                var $file = $('#' + file.id);
                var imageUrl=editor.getOpt("imageUrlPrefix")+ret.properties.url;
                try {
                    ...
                    if (ret.result==10000) {
                        ...
                        ue.execCommand('insertimage', {src:imageUrl});
