package com.vg.project.system.menu.domain;
...
public class Menu extends BaseEntity
{
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(getMenuId(), menu.getMenuId()) &&
                ...
                Objects.equals(getParentName(), menu.getParentName()) &&
                Objects.equals(getParentId(), menu.getParentId()) &&
                Objects.equals(getUrl(), menu.getUrl()) &&
                Objects.equals(getMenuType(), menu.getMenuType()) &&
                Objects.equals(getVisible(), menu.getVisible()) &&
                Objects.equals(getPerms(), menu.getPerms());
    }

    @Override
    public int hashCode() {
        return Objects.hash(getMenuId(), getMenuName(), getParentName(), getParentId(), getUrl(), getMenuType(), getVisible(), getPerms());
    }
}
