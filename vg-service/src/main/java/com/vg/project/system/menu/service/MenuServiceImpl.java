package com.vg.project.system.menu.service;
...
import com.vg.project.system.menu.mapper.MenuMapper;
...
public class MenuServiceImpl implements IMenuService
{
    ...
    public List<Map<String, Object>> roleMenuTreeData(Role role)
    {
        ...
        for (Role ro : roles) {
            roleSet.addAll(Arrays.asList(ro.getRoleKey().trim().split(",")));
        }
        List<Menu> menuList=new ArrayList<>();
        if(userType.equals("Platform")&&roleSet.contains("Admin")){
            menuList = menuMapper.selectMenuAll();
        }else {
            menuList = menuMapper.selectAllMenusByUserId(ShiroUtils.getUserId());
        }

//        List<Menu> menuList = menuMapper.selectMenuAll();
        //List<Menu> menuList = menuMapper.selectAllMenusByUserId(ShiroUtils.getUserId());
    ...
    @Override
    public List<Menu> selectMenusByPerms(String perms) {
        return menuMapper.selectMenusByPerms(perms);
    }
